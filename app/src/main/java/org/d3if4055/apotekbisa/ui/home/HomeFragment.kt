...
import org.d3if4055.apotekbisa.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.apotekBisa.observe(viewLifecycleOwner, Observer {
            val adapter = ApotekBisaAdapter(it)
...
//        }
    ...
    override fun onRecyclerViewItemClicked(view: View, apotekBisa: ApotekBisa) {
        val bundle = bundleOf("dataBarberShop" to apotekBisa)
